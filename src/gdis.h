...
enum { ATOM_ORDER_TYPE_1, ATOM_ORDER_TYPE_2, ATOM_ORDER_TYPE_3, ATOM_ORDER_TYPE_4, ATOM_ORDER_TYPE_5 };
enum { MOL_ORDER_TYPE_1, MOL_ORDER_TYPE_2, MOL_ORDER_TYPE_3, MOL_ORDER_TYPE_4, MOL_ORDER_TYPE_5 };
